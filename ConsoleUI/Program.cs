...
namespace ConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //carManager.Add(new Car() { CarId = 1, BrandId = 6, ColorId = 1, DailyPrice = 300, Description = "Beyaz Ford Focus", ModelYear = 2014 });
            ...
            foreach (var car in carManager.GetCarsDailyPrice(400, 500))
            {
                Console.WriteLine(car.Description);
            }
        }
